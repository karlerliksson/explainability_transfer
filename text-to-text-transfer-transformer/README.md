...
NOTE: Adapted from the [original T5 Github repo](https://github.com/google-research/text-to-text-transfer-transformer/tree/df39c8864aad1058bcfb9707bec7231569c641db) with modifications to the T5 Huggingface model wrapper. Original README follows below.
