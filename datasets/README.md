...
NOTE: Extended from the [Tensorflow Datasets repo](https://github.com/tensorflow/datasets) with datasets for SciFact, MultiRC and FEVER for explainability transfer purposes. Original README follows below.
