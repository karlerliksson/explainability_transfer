...
from tensorflow_datasets.text.eraser_multi_rc2 import EraserMultiRc2
from tensorflow_datasets.text.scifact import Scifact
from tensorflow_datasets.text.fever import Fever
